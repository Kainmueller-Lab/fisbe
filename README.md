...
[[**`Paper`**](https://openreview.net/forum?id=)] [[**`Project`**](https://kainmueller-lab.github.io/flylight_inst_seg_dataset/)] [[**`Documentation`**](https://kainmueller-lab.github.io/flylight_inst_seg_dataset/datasheet)] [[**`Metrics`**](#metrics)] [[**`Leaderboard`**](#leaderboard)] [[**`BibTeX`**](#citation)] [[**`Changelog`**](https://kainmueller-lab.github.io/flylight_inst_seg_dataset/changelog)]
...
*[>> The FlyLight Instance Segmentation Dataset Datasheet](https://kainmueller-lab.github.io/flylight_inst_seg_dataset/datasheet)*
...
All future change will be listed [on the changelog page](https://kainmueller-lab.github.io/flylight_inst_seg_dataset/changelog).
